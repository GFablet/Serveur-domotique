...
public class CParserDSDL implements CParserDSDLConstants {
  ...
  final public void Instruction() throws ParseException {
    ...
    case SWITCH_ON:
      SwitchOnAction();
      System.out.println("Instruction lue (allumer) !");
      break;
    case SWITCH_OFF:
      SwitchOffAction();
      System.out.println("Instruction lue !(eteindre) ");
      break;
    default:
      jj_la1[2] = jj_gen;
      jj_consume_token(-1);
  ...
  final public void SwitchOffAction() throws ParseException {
    Token t1 = null;
    Token t2 = null;
    Token t3 = null;
    Token t4 = null;
    Token t5 = null;
    jj_consume_token(SWITCH_OFF);
    t1 = jj_consume_token(ID);
    jj_consume_token(OF);
    jj_consume_token(PAR_OPEN);
    t2 = jj_consume_token(ID);
    ...
    jj_consume_token(EOL);
        if ( (t4 == null) && (t5 == null) ) {
            System.out.println("Eteindre équipement !");
        }
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc0000c,0xc0000c,0xc00000,0x2000,};
   }
